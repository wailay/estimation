...
const FraisGeneraux = require('../frais-generaux/frais-generaux');
...
// frais genereaux
Resource.belongsToMany(Project, { through: FraisGeneraux });
Project.belongsToMany(Resource, { through: FraisGeneraux });
